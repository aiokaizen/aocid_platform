    ...
    (function () {
      ...
      window.addEventListener("load", function () {
        ...
        var validation = Array.prototype.filter.call(forms, function (form) {
          const loading_icon = form.querySelector('.btn-loading');
          form.addEventListener("submit", function (event) {
            ...
            if (form.checkValidity() === true) {
              ...
              var isJoinUsForm = form.classList.contains('join_us_form');
              var isCommentForm = form.classList.contains('comment_form');
              ...
              if (isContactForm) {
                ...
                fetch("/contact_us", {
                  ...
                  const txt = "An error has occured. Please use another method to reach us while we investigate the problem."
                  var alertBox = '<div class="alert ' + alertClass + ' alert-dismissible fade show"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' + txt + '</div>';
                  if (alertClass && txt) {
                    form.querySelector(".messages").insertAdjacentHTML('beforeend', alertBox);
                    form.reset();
              ...
              if (isCommentForm) {
                ...
                let post_slug_value = post_slug.innerText

                var data = new FormData(form);
                var alertClass = 'alert-danger';
                fetch("/blog/posts/" + post_slug_value + "/", {
                  method: "post",
                  body: data
                }).then((data) => {
                  loading_icon.classList.add('d-none');
